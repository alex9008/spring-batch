...
import example.billingjob.bulkrefunds.ReportingData;
...
public class BillingJobConfiguration {
    ...
    @Bean
    public Job billingJob(JobRepository jobRepository, Step billingJobStep1, Step billingJobStep2, Step billingJobStep3) {
        return new JobBuilder("BillingJob", jobRepository)
                .start(billingJobStep1)
                .next(billingJobStep2)
                .next(billingJobStep3)
                .build();
    }

    @Bean
    public Step billingJobStep1(JobRepository jobRepository, JdbcTransactionManager transactionManager) {
    ...
    @Bean
    @StepScope
    public FlatFileItemReader<BillingData> billingDataFileReader(@Value("#{jobParameters['input.file2']}") String inputFile1) {

        return new FlatFileItemReaderBuilder<BillingData>()
                .name("billingDataFileReader")
                .resource(new FileSystemResource(inputFile1))
                .delimited()
    ...
    @Bean
    public Step billingJobStep2(JobRepository jobRepository, JdbcTransactionManager transactionManager,
    ...
    @Bean
    public Step billingJobStep3(JobRepository jobRepository, JdbcTransactionManager transactionManager,
